...
export class Migrations1730410615802 implements MigrationInterface {
  name = 'Migrations1730410615802';
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "permission" ("permissionId" uuid NOT NULL DEFAULT uuid_generate_v4(), "permissionName" character varying NOT NULL, CONSTRAINT "UQ_d89e1dadfa403bfefa4d49f7ecf" UNIQUE ("permissionName"), CONSTRAINT "PK_86b314be9c1be5c62b3a9d97ae4" PRIMARY KEY ("permissionId"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "rol" ("rolId" uuid NOT NULL DEFAULT uuid_generate_v4(), "rolName" character varying NOT NULL, "rolDescription" character varying NOT NULL, "rolStatus" boolean NOT NULL, CONSTRAINT "UQ_5ba1e853e4f23d5d81090717b09" UNIQUE ("rolName"), CONSTRAINT "PK_facc3d8a3785a82fbae5b77ed01" PRIMARY KEY ("rolId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tax" ("taxId" uuid NOT NULL DEFAULT uuid_generate_v4(), "taxName" character varying(255) NOT NULL, "taxPorcentage" numeric(5,2) NOT NULL, CONSTRAINT "UQ_6899fb8bf11455512430a85701e" UNIQUE ("taxName"), CONSTRAINT "PK_0434ce9598f6667b9b6cde56c92" PRIMARY KEY ("taxId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ADD CONSTRAINT "FK_9c8147145b290c8c4cfc64a9660" FOREIGN KEY ("supplierSupplierId") REFERENCES "supplier"("supplierId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "supplier" ADD CONSTRAINT "FK_0b9eb7611d8e89ce117ea7c5d2a" FOREIGN KEY ("companyCompanyId") REFERENCES "company"("companyId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "headquarter" ADD CONSTRAINT "FK_24d6599e32aeb98784a9f28adb0" FOREIGN KEY ("companyCompanyId") REFERENCES "company"("companyId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "customer" ADD CONSTRAINT "FK_b79d86139a9bc3f552bcc8f5509" FOREIGN KEY ("companyCompanyId") REFERENCES "company"("companyId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sale" ADD CONSTRAINT "FK_99b0e8173f6b390ed5fd549016a" FOREIGN KEY ("employeeEmployeeId") REFERENCES "employee"("employeeId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sale" ADD CONSTRAINT "FK_dad84e2c29484e4c07d07529e44" FOREIGN KEY ("customerCustomerId") REFERENCES "customer"("customerId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "employee" ADD CONSTRAINT "FK_ded048330ab60e923b61eec5fcc" FOREIGN KEY ("headquarterHeadquarterId") REFERENCES "headquarter"("headquarterId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_80bc4680c00f296e3eebba5e402" FOREIGN KEY ("rolRolId") REFERENCES "rol"("rolId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "permission_rol" ADD CONSTRAINT "FK_09dd5ff578b95b8f302263d1d65" FOREIGN KEY ("rolRolId") REFERENCES "rol"("rolId") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "permission_rol" ADD CONSTRAINT "FK_12acb0ce2f8509b1802d19c0e20" FOREIGN KEY ("permissionPermissionId") REFERENCES "permission"("permissionId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_tax" ADD CONSTRAINT "FK_0703beddc1b20f2812d56516cf3" FOREIGN KEY ("productProductId") REFERENCES "product"("productId") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_tax" ADD CONSTRAINT "FK_0e349177fe408d8390320e4f93e" FOREIGN KEY ("taxTaxId") REFERENCES "tax"("taxId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product_tax" DROP CONSTRAINT "FK_0e349177fe408d8390320e4f93e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_tax" DROP CONSTRAINT "FK_0703beddc1b20f2812d56516cf3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "permission_rol" DROP CONSTRAINT "FK_12acb0ce2f8509b1802d19c0e20"`,
    );
    await queryRunner.query(
      `ALTER TABLE "permission_rol" DROP CONSTRAINT "FK_09dd5ff578b95b8f302263d1d65"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "FK_80bc4680c00f296e3eebba5e402"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "FK_112bf253789ceb9200b8b874b58"`,
    );
    await queryRunner.query(
      `ALTER TABLE "employee" DROP CONSTRAINT "FK_ded048330ab60e923b61eec5fcc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sale" DROP CONSTRAINT "FK_d921dad2016acbaeaaa7abc58a0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sale" DROP CONSTRAINT "FK_dad84e2c29484e4c07d07529e44"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sale" DROP CONSTRAINT "FK_99b0e8173f6b390ed5fd549016a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "customer" DROP CONSTRAINT "FK_b79d86139a9bc3f552bcc8f5509"`,
    );
    await queryRunner.query(
      `ALTER TABLE "headquarter" DROP CONSTRAINT "FK_24d6599e32aeb98784a9f28adb0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "supplier" DROP CONSTRAINT "FK_0b9eb7611d8e89ce117ea7c5d2a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" DROP CONSTRAINT "FK_9c8147145b290c8c4cfc64a9660"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0e349177fe408d8390320e4f93"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0703beddc1b20f2812d56516cf"`,
    );
    await queryRunner.query(`DROP TABLE "product_tax"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_12acb0ce2f8509b1802d19c0e2"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_09dd5ff578b95b8f302263d1d6"`,
    );
