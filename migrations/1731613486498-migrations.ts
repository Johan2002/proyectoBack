...
export class Migrations1731613486498 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "pdf_file" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "fileData" bytea NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_755efe31cd4ebf040dc679c3d26" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
